...
<html lang="en">
    ...
    <body>
        ...
        <section class="banner d-flex justify-content-center alig-items-center pt-5">
            <div class="container my-5 py-5 banner-desc">
                ...
                <div class="col-md-6"></div>
                    <div class="col-me-6">
                        <h1 class="text-capitalize py-3 redressed">Nos sports <br> de compétition<h1>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="cc-menu py-5 merriweather">
            <div class="container">
                <div class="row">
                  <h3 class="text-center text-light merriweather">Nos sports de compétitions</h3>
                  <div class="card bg-transparent text-center">
                    <div class="card-header redressed fs-4">
                      <ul class="nav nav-tabs justify-content-center card-header-tabs text-light">
                        <li class="nav-item">
                          <a class="nav-link active" aria-current="true" href="#">Dépassement de soi</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link text-light" href="#">Fair-play</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link text-light">Victoire</a>
                        </li>
                      </ul>
                    </div>
                    <div class="card-body">
                      <h5 class="card-title text-light">Objectifs :</h5>
                      <p class="card-text text-light">Pour chacun de ces sports, des équipes de compétition sont créés afin de répresenter au mieux le groupe OMNES SPORT</p>
                    </div>
                  </div>
                </div>
                <div class="row row-cols-1 row-cols-md-2 g-4">
                  <div class="col">
                    <div class="card">
                      <img src="assets/css/Basket1.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title font-weight-bold">Basket-Ball</h5>
                        <a href="basket.php" class="btn btn-primary">Voir</a>
                      </div>
                    </div>
                  </div>
                  <div class="col">
                    <div class="card">
                      <img src="assets/css/Foot1.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">FootBall</h5>
                        <a href="foot.php" class="btn btn-primary">Voir</a>
                      </div>
                    </div>
                  </div>
                  <div class="col">
                    <div class="card">
                      <img src="assets/css/Rugby1.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">Rugby</h5>
                        <a href="rugby.php" class="btn btn-primary">Voir</a>
                      </div>
                    </div>
                  </div>
                  <div class="col">
                    <div class="card">
                      <img src="assets/css/Tennis1.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">Tennis</h5>
                        <a href="tennis.php" class="btn btn-primary">Voir</a>
                      </div>
                    </div>
                  </div>
                  <div class="col">
                    <div class="card">
                      <img src="assets/css/Natation1.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">Natation</h5>
                        <a href="natation.php" class="btn btn-primary">Voir</a>
                      </div>
                    </div>
                  </div>
                  <div class="col">
                    <div class="card">
                      <img src="assets/css/Plongeon1.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">Plongeon</h5>
                        <a href="plongeon.php" class="btn btn-primary">Voir</a>
                      </div>
                    </div>
                  </div>
                </div>
